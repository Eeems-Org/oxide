...
class Controller : public QObject
{
    ...
    Q_PROPERTY(
        int lockAfter MEMBER m_lockAfter WRITE setLockAfter NOTIFY
            lockAfterChanged
    )
    Q_PROPERTY(
    ...
    Q_PROPERTY(
        NotificationList* notifications MEMBER notifications READ
            getNotifications NOTIFY notificationsChanged
    )
    ...
    Q_PROPERTY(
        bool hasNotification MEMBER m_hasNotification NOTIFY
  ...
  public:
      ...
      , applications()
    {
        ...
        connect(
            powerApi, &Power::batteryAlert, this, &Controller::batteryAlert
        );
        connect(
        ...
        connect(
            wifiApi, &Wifi::stateChanged, this, &Controller::wifiStateChanged
        );
        connect(
            wifiApi, &Wifi::rssiChanged, this, &Controller::wifiRssiChanged
        );
    ...
    Q_INVOKABLE void disconnectWifiSignals()
    {
        ...
        disconnect(wifiApi, &Wifi::bssRemoved, this, &Controller::bssRemoved);
        disconnect(
            wifiApi, &Wifi::networkAdded, this, &Controller::networkAdded
        );
        disconnect(
