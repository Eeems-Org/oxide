...
class Controller : public QObject
{
    ...
    Q_PROPERTY(
        bool leftSwipeEnabled READ leftSwipeEnabled NOTIFY
            leftSwipeEnabledChanged
    )
    Q_PROPERTY(
    ...
    Q_PROPERTY(
        bool downSwipeEnabled READ downSwipeEnabled NOTIFY
            downSwipeEnabledChanged
    )
    Q_PROPERTY(
        int leftSwipeLength READ leftSwipeLength NOTIFY leftSwipeLengthChanged
    )
    Q_PROPERTY(
        int rightSwipeLength READ rightSwipeLength NOTIFY
            rightSwipeLengthChanged
    )
    ...
    Q_INVOKABLE void back()
    {
        ...
        if (currentApplication != nullptr &&
            currentApplication->path() ==
                appsAPI->lockscreenApplication().path()) {
