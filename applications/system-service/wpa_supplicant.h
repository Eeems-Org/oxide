 ...
 * Command line was: qdbusxml2cpp -N -p wpa_supplicant.h:wpa_supplicant.cpp
...
class FiW1Wpa_supplicant1Interface : public QDBusAbstractInterface
{
  ...
  public Q_SLOTS: // METHODS
    inline QDBusPendingReply<QDBusObjectPath> CreateInterface(
    ...
    )
    {
        ...
        return asyncCallWithArgumentList(
            QStringLiteral("CreateInterface"), argumentList
        );
    }

    inline QDBusPendingReply<QDBusObjectPath> GetInterface(
    ...
    )
    {
        ...
        return asyncCallWithArgumentList(
            QStringLiteral("GetInterface"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<> RemoveInterface(const QDBusObjectPath& path)
    {
        ...
        return asyncCallWithArgumentList(
            QStringLiteral("RemoveInterface"), argumentList
        );
    }
...
class FiW1Wpa_supplicant1BSSInterface : public QDBusAbstractInterface
{
  ...
  public:
    ...
    inline uint age() const { return qvariant_cast<uint>(property("Age")); }
...
class FiW1Wpa_supplicant1InterfaceInterface : public QDBusAbstractInterface
{
  ...
  public Q_SLOTS: // METHODS
    ...
    AddBlob(const QString& name, const QByteArray& data)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(name) << QVariant::fromValue(data);
        return asyncCallWithArgumentList(
            QStringLiteral("AddBlob"), argumentList
        );
    }

    inline QDBusPendingReply<QDBusObjectPath> AddNetwork(
        const QVariantMap& args
    )
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(args);
        return asyncCallWithArgumentList(
            QStringLiteral("AddNetwork"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<> AutoScan(const QString& arg)
    {
        ...
        return asyncCallWithArgumentList(
            QStringLiteral("AutoScan"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<> Disconnect()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(
            QStringLiteral("Disconnect"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<> EAPLogoff()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(
            QStringLiteral("EAPLogoff"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<> EAPLogon()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(
            QStringLiteral("EAPLogon"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<> FlushBSS(uint age)
    {
        ...
        return asyncCallWithArgumentList(
            QStringLiteral("FlushBSS"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<QByteArray> GetBlob(const QString& name)
    {
        ...
        return asyncCallWithArgumentList(
            QStringLiteral("GetBlob"), argumentList
        );
    }

    inline QDBusPendingReply<> NetworkReply(
    ...
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(path) << QVariant::fromValue(field)
                     << QVariant::fromValue(value);
        return asyncCallWithArgumentList(
            QStringLiteral("NetworkReply"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<> Reassociate()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(
            QStringLiteral("Reassociate"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<> Reattach()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(
            QStringLiteral("Reattach"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<> Reconnect()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(
            QStringLiteral("Reconnect"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<> RemoveAllNetworks()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(
            QStringLiteral("RemoveAllNetworks"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<> RemoveBlob(const QString& name)
    {
        ...
        argumentList << QVariant::fromValue(name);
        return asyncCallWithArgumentList(
            QStringLiteral("RemoveBlob"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<> RemoveNetwork(const QDBusObjectPath& path)
    {
        ...
        argumentList << QVariant::fromValue(path);
        return asyncCallWithArgumentList(
            QStringLiteral("RemoveNetwork"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<> SelectNetwork(const QDBusObjectPath& path)
    {
        ...
        argumentList << QVariant::fromValue(path);
        return asyncCallWithArgumentList(
            QStringLiteral("SelectNetwork"), argumentList
        );
    }

    inline QDBusPendingReply<> SetPKCS11EngineAndModulePath(
        const QString& pkcs11_engine_path,
        const QString& pkcs11_module_path
    )
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(pkcs11_engine_path)
                     << QVariant::fromValue(pkcs11_module_path);
        return asyncCallWithArgumentList(
            QStringLiteral("SetPKCS11EngineAndModulePath"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<QVariant> SignalPoll()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(
            QStringLiteral("SignalPoll"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<> SubscribeProbeReq()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(
            QStringLiteral("SubscribeProbeReq"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<> TDLSDiscover(const QString& peer_address)
    {
        ...
        return asyncCallWithArgumentList(
            QStringLiteral("TDLSDiscover"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<> TDLSSetup(const QString& peer_address)
    {
        ...
        argumentList << QVariant::fromValue(peer_address);
        return asyncCallWithArgumentList(
            QStringLiteral("TDLSSetup"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<QString> TDLSStatus(const QString& peer_address)
    {
        ...
        argumentList << QVariant::fromValue(peer_address);
        return asyncCallWithArgumentList(
            QStringLiteral("TDLSStatus"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<> TDLSTeardown(const QString& peer_address)
    {
        ...
        argumentList << QVariant::fromValue(peer_address);
        return asyncCallWithArgumentList(
            QStringLiteral("TDLSTeardown"), argumentList
        );
    }
    ...
    inline QDBusPendingReply<> UnsubscribeProbeReq()
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(
            QStringLiteral("UnsubscribeProbeReq"), argumentList
        );
    }
  ...
  Q_SIGNALS: // SIGNALS
    ...
    void
    NetworkAdded(const QDBusObjectPath& path, const QVariantMap& properties);
