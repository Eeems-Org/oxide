...
int main(int argc, char* argv[]) {
    ...
    parser.setApplicationDescription(
        "Validates application registration files"
    );
    ...
    QCommandLineOption noWarnDeprecatedOption(
        "no-warn-deprecated",
        "Do not warn about usage of deprecated items that were defined in the "
    ...
    parser.addPositionalArgument(
        "file", "Application registration(s) to validate", "FILE..."
    );
    parser.process(app);
