...
class Controller : public QObject
{
    ...
    Q_PROPERTY(
        bool applicationUsage READ applicationUsage WRITE setApplicationUsage
            NOTIFY applicationUsageChanged
    )
    Q_PROPERTY(
  ...
  public:
    Controller(QObject* parent) : QObject(parent), confirmPin()
    {
        ...
        connect(
            systemApi,
            &System::deviceSuspending,
            this,
            &Controller::deviceSuspending
        );
        ...
        if (QFile::exists(settings.fileName())) {
            ...
            if (settings.contains("onLogin")) {
                ...
                sharedSettings.set_onLogin(
                    settings.value("onLogin").toString()
                );
            }
