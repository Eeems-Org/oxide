    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                height: width
                color: root.value.length > 0 ? root.itemTextColor : root.itemBackgrondColor
            ...
            Rectangle {
                width: parent.itemSize
                height: width
                color: root.value.length > 1 ? root.itemTextColor : root.itemBackgrondColor
                border.color: root.itemBorderColor
                border.width: root.itemBorderWidth
                radius: width / 2
            }
            Rectangle {
                width: parent.itemSize
                height: width
                color: root.value.length > 2 ? root.itemTextColor : root.itemBackgrondColor
                border.color: root.itemBorderColor
                border.width: root.itemBorderWidth
                radius: width / 2
            }
            Rectangle {
                width: parent.itemSize
                height: width
                color: root.value.length > 3 ? root.itemTextColor : root.itemBackgrondColor
                border.color: root.itemBorderColor
                border.width: root.itemBorderWidth
                radius: width / 2
            }
