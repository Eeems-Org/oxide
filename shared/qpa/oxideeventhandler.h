...
private slots:
  void readyRead();
  void
  processKeyboardEvent(DeviceData* data, Blight::partial_input_event_t* event);
  void
  processTabletEvent(DeviceData* data, Blight::partial_input_event_t* event);
  void
  processTouchEvent(DeviceData* data, Blight::partial_input_event_t* event);
  void
  processPointerEvent(DeviceData* data, Blight::partial_input_event_t* event);
