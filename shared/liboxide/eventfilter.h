...
namespace Oxide {
     ...
     * They are then sent to every enabled/visible widget at the x/y coordinate
     * that have a parent widget, and accept left mouse button input. This
     * doens't always work as some widgets aren't found with the current method
     * of finding widgets at a location.
     *
