...
namespace Oxide {
  ...
  class LIBOXIDE_EXPORT XochitlSettings : public SettingsFile {
     ...
     */
    Q_PROPERTY(
      WifiNetworks wifinetworks MEMBER m_wifinetworks READ wifinetworks WRITE
        setWifinetworks RESET resetWifinetworks NOTIFY wifinetworksChanged
    )
